...
export const MenuBar: React.FC<Props> = ({
  ...
  <Menu pointing>
    <Menu.Item header>AAKALAN | Evaluate with Ease</Menu.Item>
    <Menu.Menu position="right">
      {isPdfLoaded && (
        <>
          ...
          >
            <Dropdown.Menu>
              <Dropdown.Item onClick={addText}>Add Feedback</Dropdown.Item>
              <Dropdown.Item onClick={addImage}>Add Image</Dropdown.Item>
              <Dropdown.Item onClick={addDrawing}>Add Marks</Dropdown.Item>
            </Dropdown.Menu>
          </Dropdown>
          <Menu.Item
